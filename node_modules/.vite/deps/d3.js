...
function brush(dim) {
  ...
  function started(event) {
    ...
    if (!filter7.apply(this, arguments))
      return;
    var that = this, type2 = event.target.__data__.type, mode3 = (keys && event.metaKey ? type2 = "overlay" : type2) === "selection" ? MODE_DRAG : keys && event.altKey ? MODE_CENTER : MODE_HANDLE, signX = dim === Y ? null : signsX[type2], signY = dim === X ? null : signsY[type2], state = local3(that), extent4 = state.extent, selection4 = state.selection, W = extent4[0][0], w0, w1, N = extent4[0][1], n0, n1, E3 = extent4[1][0], e0, e1, S = extent4[1][1], s0, s1, dx = 0, dy = 0, moving, shifting = signX && signY && keys && event.shiftKey, lockX, lockY, points = Array.from(event.touches || [event], (t) => {
...
function contours_default() {
  ...
  function isorings(values, value, callback) {
    var fragmentByStart = new Array(), fragmentByEnd = new Array(), x4, y4, t04, t14, t23, t33;
    x4 = y4 = -1;
...
function hue2(a4, b) {
  var d = b - a4;
  return d ? linear3(a4, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant_default12(isNaN(a4) ? b : a4);
}
function gamma2(y4) {
  return (y4 = +y4) === 1 ? nogamma2 : function(a4, b) {
    return b - a4 ? exponential2(a4, b, y4) : constant_default12(isNaN(a4) ? b : a4);
  };
}
function nogamma2(a4, b) {
  var d = b - a4;
  return d ? linear3(a4, d) : constant_default12(isNaN(a4) ? b : a4);
}
...
function value_default2(a4, b) {
  var t = typeof b, c6;
  return b == null || t === "boolean" ? constant_default12(b) : (t === "number" ? number_default3 : t === "string" ? (c6 = color2(b)) ? (b = c6, rgb_default2) : string_default2 : b instanceof color2 ? rgb_default2 : b instanceof Date ? date_default2 : isNumberArray2(b) ? numberArray_default2 : Array.isArray(b) ? genericArray2 : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default2 : number_default3)(a4, b);
}
...
function interpolateTransform2(parse, pxComma, pxParen, degParen) {
  ...
  function rotate(a4, b, s2, q) {
    if (a4 !== b) {
      if (a4 - b > 180)
        ...
        a4 += 360;
      q.push({ i: s2.push(pop(s2) + "rotate(", null, degParen) - 2, x: number_default3(a4, b) });
    } else if (b) {
      s2.push(pop(s2) + "rotate(" + b + degParen);
    }
  }
  function skewX(a4, b, s2, q) {
    if (a4 !== b) {
      q.push({ i: s2.push(pop(s2) + "skewX(", null, degParen) - 2, x: number_default3(a4, b) });
    } else if (b) {
      s2.push(pop(s2) + "skewX(" + b + degParen);
    }
  }
...
function transformer2() {
  var domain = unit, range5 = unit, interpolate = value_default2, transform2, untransform, unknown, clamp = identity5, piecewise3, output, input;
  function rescale() {
  ...
  scale2.invert = function(y4) {
    return clamp(untransform((input || (input = piecewise3(range5, domain.map(transform2), number_default3)))(y4)));
  };
  scale2.domain = function(_) {
  ...
  scale2.rangeRound = function(_) {
    return range5 = Array.from(_), interpolate = round_default3, rescale();
  };
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function tickInterval(start2, stop, count5) {
    ...
    if (i === tickIntervals.length)
      return year.every(tickStep(start2 / durationYear, stop / durationYear, count5));
    if (i === 0)
...
function transformer3() {
  var x06 = 0, x12 = 1, t04, t14, k10, transform2, interpolator = identity5, clamp = false, unknown;
  function scale2(x4) {
  ...
  scale2.rangeRound = range5(round_default3);
  scale2.unknown = function(_) {
    return arguments.length ? (unknown = _, scale2) : unknown;
  };
  return function(t) {
...
function transformer4() {
  var x06 = 0, x12 = 0.5, x22 = 1, s2 = 1, t04, t14, t23, k10, k21, interpolator = identity5, transform2, clamp = false, unknown;
  function scale2(x4) {
  ...
  scale2.domain = function(_) {
    return arguments.length ? ([x06, x12, x22] = _, t04 = transform2(x06 = +x06), t14 = transform2(x12 = +x12), t23 = transform2(x22 = +x22), k10 = t04 === t14 ? 0 : 0.5 / (t14 - t04), k21 = t14 === t23 ? 0 : 0.5 / (t23 - t14), s2 = t14 < t04 ? -1 : 1, scale2) : [x06, x12, x22];
  };
  scale2.clamp = function(_) {
    return arguments.length ? (clamp = !!_, scale2) : clamp;
  };
  ...
  function range5(interpolate) {
    return function(_) {
      var r0, r1, r2;
      return arguments.length ? ([r0, r1, r2] = _, interpolator = piecewise2(interpolate, [r0, r1, r2]), scale2) : [interpolator(0), interpolator(0.5), interpolator(1)];
    };
  }
  scale2.range = range5(value_default2);
  scale2.rangeRound = range5(round_default3);
  ...
  return function(t) {
    transform2 = t, t04 = t(x06), t14 = t(x12), t23 = t(x22), k10 = t04 === t14 ? 0 : 0.5 / (t14 - t04), k21 = t14 === t23 ? 0 : 0.5 / (t23 - t14), s2 = t14 < t04 ? -1 : 1;
    return scale2;
  };
}
function diverging() {
...
function cornerTangents(x06, y06, x12, y12, r1, rc, cw) {
  var x01 = x06 - x12, y01 = y06 - y12, lo = (cw ? rc : -rc) / sqrt3(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x06 + ox, y11 = y06 + oy, x10 = x12 + ox, y10 = y12 + oy, x004 = (x11 + x10) / 2, y004 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d2 = dx * dx + dy * dy, r = r1 - rc, D4 = x11 * y10 - x10 * y11, d = (dy < 0 ? -1 : 1) * sqrt3(max6(0, r * r * d2 - D4 * D4)), cx0 = (D4 * dy - dx * d) / d2, cy0 = (-D4 * dx - dy * d) / d2, cx1 = (D4 * dy + dx * d) / d2, cy1 = (-D4 * dx + dy * d) / d2, dx0 = cx0 - x004, dy0 = cy0 - y004, dx1 = cx1 - x004, dy1 = cy1 - y004;
...
function pie_default() {
  var value = identity_default6, sortValues = descending_default2, sort4 = null, startAngle = constant_default14(0), endAngle = constant_default14(tau7), padAngle = constant_default14(0);
  function pie(data) {
...
function zoom_default3() {
  ...
  function dblclicked(event, ...args) {
    if (!filter7.apply(this, arguments))
      return;
    var t04 = this.__zoom, p02 = pointer_default(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t04.invert(p02), k1 = t04.k * (event.shiftKey ? 0.5 : 2), t14 = constrain(translate(scale2(t04, k1), p02, p1), extent3.apply(this, args), translateExtent);
    noevent_default3(event);
    if (duration > 0)
      select_default(this).transition().duration(duration).call(schedule, t14, p02, event);
    else
      select_default(this).call(zoom.transform, t14, p02, event);
  }
  ...
  zoom.filter = function(_) {
    return arguments.length ? (filter7 = typeof _ === "function" ? _ : constant_default15(!!_), zoom) : filter7;
  };
