<script>
  ...
  function setupChart() {
    ...
    const container = d3.select('#custom-chart-container1000')
      .select("svg")
      .remove(); // Remove any existing chart

    const svg = d3.select('#custom-chart-container1000')
      .append('svg')
...
<div id="custom-chart-container1000"></div>

<style>
  #custom-chart-container1000 {
    width: 600px;
    height: 400px;
    margin-left: auto;
    margin-right: auto;
