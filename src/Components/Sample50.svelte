<script>
  ...
  function setupChart() {
    ...
    const container = d3.select('#custom-chart-container50')
      .select("svg")
      .remove(); // Remove any existing chart

    const svg = d3.select('#custom-chart-container50')
      .append('svg')
...
<div id="custom-chart-container50"></div>

<style>
  #custom-chart-container50 {
    width: 600px;
    height: 400px;
    margin-left: auto;
    margin-right: auto;
